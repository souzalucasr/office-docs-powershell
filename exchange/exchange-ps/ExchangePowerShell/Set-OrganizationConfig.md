...
The RecipientDelimiters parameter specifies the tenant-wide default value for the Mail Compose and Reply setting that controls whether commas are used to separate recipients. Valid values are:

- $true: Commas are used to separate recipients by default. This value is the default.
- $false: Commas aren't used to separate recipients by default.
